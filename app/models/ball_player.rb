class BallPlayer < ActiveRecord::Base
  attr_accessible :first_name, :last_name, :position, :born, :height, :weight, :rookie_year

  validates :first_name, :last_name, :position, :born, :height, :weight, :rookie_year, presence: true
